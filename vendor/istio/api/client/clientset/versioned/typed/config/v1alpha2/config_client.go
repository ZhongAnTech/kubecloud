...
import (
	"istio/api/client/clientset/versioned/scheme"
...
func (c *ConfigV1alpha2Client) DestinationPolicies(namespace string) DestinationPolicyInterface {
	return newDestinationPolicies(c, namespace)
}

func (c *ConfigV1alpha2Client) EgressRules(namespace string) EgressRuleInterface {
	return newEgressRules(c, namespace)
}

func (c *ConfigV1alpha2Client) IngressRules(namespace string) IngressRuleInterface {
	return newIngressRules(c, namespace)
}
